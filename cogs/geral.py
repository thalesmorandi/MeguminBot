...
class Geral:
    ...
    async def help(self, ctx, option: str = None):
        ...
        try:
            ...
            embed.add_field(name="Programação", value="`json`, `py`")
            embed.add_field(name="Ações", value="`abraçar`, `beijar`, `carinho`, `socar`")
            embed.add_field(name="Diversos", value="`senha`, `diz`, `repete`, `ping`, `donate`, `convite`")
