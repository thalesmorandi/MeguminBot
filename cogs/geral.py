...
class Geral:
    ...
    async def qr(self, ctx, *, message: str):
        ...
        new_message = message.replace("/", "%2F")
        print(new_message)
        url = f"https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={new_message}"
        embed = discord.Embed(color=0xDEADBF)
    ...
    async def help(self, ctx, option: str = None):
        ...
        try:
            ...
            embed.add_field(name="Fortnite", value="`solo`, `duo`, `squad`", inline=False)
